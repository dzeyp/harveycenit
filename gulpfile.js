...
// Copy Swiper files
    /*gulp.src(basePaths.node + 'slider-pro/dist/css/slider-pro.min.css')
        .pipe(gulp.dest(basePaths.css));

    gulp.src(basePaths.node + 'slider-pro/dist/js/jquery.sliderPro.min.js')
        .pipe(gulp.dest(basePaths.js));*/

// Copy Swiper files
    gulp.src(basePaths.node + 'jquery-parallax.js/parallax.min.js')
        .pipe(gulp.dest(basePaths.js));

// Shuffle.js
    gulp.src(basePaths.node + 'shufflejs/dist/shuffle.min.js')
        .pipe(gulp.dest(basePaths.js));
    return stream;
});
