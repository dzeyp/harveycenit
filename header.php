    ...
    <div class="container-fluid" id="main-slider">
        ...
        <!-- <div class="slick-slider">
            <div>
                ...
                <div class="slide-0" style="background: url('http://localhost/wordpress/wp-content/uploads/2017/09/harvey1.jpg') no-repeat center;"></div>
            </div>
            <div>
                <div class="slick-bg"></div>
                <div class="slide-0" style="background: url('http://localhost/wordpress/wp-content/uploads/2017/09/harvey2.jpg') no-repeat center; background-size: cover;"></div>
            </div>
            <div>
                <div class="slick-bg"></div>
                <div class="slide-0" style="background: url('http://localhost/wordpress/wp-content/uploads/2017/09/harvey3.jpg') no-repeat center; background-size: cover;"></div>
            </div>
        </div> -->
